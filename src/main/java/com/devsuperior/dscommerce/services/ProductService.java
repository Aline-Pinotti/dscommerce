...
public class ProductService {
    ...
    private void copyDtoToEntity(ProductDTO dto, Product entity) {
        ...
        entity.getCategories().clear();// limpando para não repetir e excluir o que foi tirado
        dto.getCategories()
                .forEach(catDto -> entity.getCategories().add(new Category(catDto.getId(), catDto.getName())));
